    ...
    return (
        <Card
            className={cn(
                ...
                'group hover:shadow-blue/20 bg-cover bg-center hover:border-blue-500/60 hover:shadow-lg',
            ...
            <div className="it relative z-10 flex min-h-[200px] items-end justify-between">
                <div className="mb-4 flex items-end justify-between">
                    <div className="flex items-end justify-evenly gap-3">
                        <div>
                            <h3 className="translate-y-[-75px] translate-x-[100px] text-sm font-semibold bg-secondary rounded-md self-center w-[50%] text-center">{avatar?.provider}</h3>
                            ...
                            <Badge
                                ...
                                className={cn(
                                    'mt-1 border border-white/20 text-xs backdrop-blur-sm',
